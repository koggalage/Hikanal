        ...
        <div class="col-md-8" style="">
            <div class="row">
                ...
                <div  class="col-md-8 col-md-offset-2" style="border-radius: 10px;  margin-top: 5%" >
                        ...
                        <h3 align="center">(BASED ON STANDARD 1:50000 MAPS AND REAL-TIME AERIAL IMAGES)</h3>
                </div>        
            </div>
            <div class="row">
                <div  class="col-md-6 col-md-offset-2" style="border-radius: 0px; margin-top: 10%" >
                    ...
                    <?php } else { ?>
                            <div class="form-group col-md-10 pull-right" style="border-radius: 0px;">
                                <div class="col-xs-12 alert alert-block alert-danger fade in">
                                    ...
                                    <strong> Excessive Login Attempts!</strong> Invalid Username or Password.
